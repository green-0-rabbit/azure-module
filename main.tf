...
resource "azurerm_container_app" "app" {
  ...
  container_app_environment_id = var.app_config.container_app_environment_id
  ...
  dynamic "secret" {
    ...
    content {
      ...
      identity            = secret.value.key_vault_secret_id != null ? azurerm_user_assigned_identity.aca_identity.id : null
    }
  }
