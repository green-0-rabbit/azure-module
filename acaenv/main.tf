resource "azurerm_container_app_environment" "this" {
  ...
  infrastructure_resource_group_name = var.infrastructure_resource_group_name != null ? var.infrastructure_resource_group_name : local.infrastructure_resource_group_name_default
